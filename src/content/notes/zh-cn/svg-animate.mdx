...
duration: 10分钟
tags: [SVG, animate, animateTransform, animateMotion]
toc: true
lang: zh-CN
---
import CalcModeDemo from '~/components/SVG/CalcModeDemo.astro'
import AdditiveDemo from '~/components/SVG/AdditiveDemo.astro'
import AccumulateDemo from '~/components/SVG/AccumulateDemo.astro'
import AnimateMotionDemo from '~/components/SVG/AnimateMotionDemo.astro'

## 定义动画

使用`<animate>`标签定义动画，使用`href`属性来设置给哪个元素应用动画。
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  ...
  <rect id="animate" x="10" y="45" width="10" height="10" class="fill-primary" />
</svg>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  ...
  <rect id="animate-event" x="10" y="45" width="10" height="10" class="fill-primary" />
</svg>
<p class="flex-center">
  <button id="btn" class="daisy-btn">开始动画</button>
</p>
...
<rect id="animate-1" x="10" y="10" width="0" height="10" class="fill-primary" />
<rect id="animate-2" x="10" y="30" width="10" height="0" class="fill-primary" />
</svg>
<p class="flex-center">
  <button id="btn1" class="daisy-btn">开始动画</button>
</p>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <rect x="10" y="45" width="10" height="10" class="fill-primary">
    <animate
      attributeType="XML"
      attributeName="x"
...
<p class="flex-center">
  <button id="btn_inline" class="daisy-btn">开始动画</button>
</p>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <rect id="animate-keyframes" x="10" y="45" width="10" height="10" class="fill-primary">
    <animate
      attributeType="XML"
      attributeName="x"
...
<p class="flex-center">
  <button id="btn_keyframes" class="daisy-btn">开始动画</button>
</p>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <rect id="animate-transform" x="10" y="10" width="10" height="10" class="fill-primary">
    <animateTransform
      attributeType="XML"
...
<p class="flex-center">
  <button id="btn_transform" class="daisy-btn">开始动画</button>
</p>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <path d="M30 50 A 20 20 0, 1, 1, 70 50 A 20 20 0, 1, 1, 30 50" class="stroke-primary" fill="none" />
  <rect class="fill-primary" rx="2" x="-5" y="-5" width="10" height="10">
    <animateMotion
...
<p class="flex-center">
  <button id="btn_motion" class="daisy-btn">开始动画</button>
</p>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <path id="mpath" d="M0 0 C 50 13 70 70 100 100" class="stroke-primary" fill="none" />
  <rect class="fill-primary" rx="2" x="-5" y="-5" width="10" height="10">
    <animateMotion
...
<p class="flex-center">
  <button id="btn_mpath" class="daisy-btn">开始动画</button>
</p>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <rect class="fill-primary" rx="2" x="10" y="10" width="10" height="10">
    <set
      id="set_x"
      attributeName="x" 
      to="50" 
...
<p class="flex-center">
  <button id="btn_set" class="daisy-btn">开始set</button>
</p>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <path id="square" d="M10 10 H90 V90 H10 Z" class="stroke-primary" stroke-linejoin="round" fill="none" />
  <rect class="fill-primary" rx="2" x="-5" y="-5" width="10" height="10">
    <animateMotion
      begin="btn_key.click"
      dur="2s"
...
<p class="flex-center">
  <button id="btn_key" class="daisy-btn">开始动画</button>
</p>
