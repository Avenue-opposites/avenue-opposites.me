...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <CoordinateSystem viewBox={viewBox} strokeWidth={strokeWidth} triggerMode={triggerMode} point={{x: 50, y: 50}}>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
  <CoordinateSystem viewBox="0 0 50 50" strokeWidth={strokeWidth} point={{x: 50, y: 50}}>
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <CoordinateSystem viewBox={viewBox} strokeWidth={strokeWidth} triggerMode={triggerMode}>
...
<div class="flex gap-x-2 sm:gap-x-4 justify-between">
  <div class="flex-auto sm:w-80">
    ...
    <svg class="bg-base-300 w-full rounded sm:rounded-md" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
      <CoordinateSystem viewBox='0 0 100 100' strokeWidth={0.5} triggerMode={triggerMode}>
        <polygon 
