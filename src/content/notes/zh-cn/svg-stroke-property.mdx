...
duration: 10分钟
publishDate: 2024-4-08
tags: [SVG, stroke, stroke-width, stroke-linecap, stroke-linejoin, stroke-dasharray, stroke-dashoffset]
toc: true
lang: zh-cn
---
import CoordinateSystem from '~/components/SVG/CoordinateSystem.astro';
export const strokeLinejoinValues = ['miter', 'miter-clip', 'arcs', 'round', 'bevel'];
...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <CoordinateSystem viewBox="0 0 24 24" unit={2} strokeWidth={0.1}>
...
```html /stroke-linecap="butt"/ /stroke-linecap="square"/ /stroke-linecap="round"/
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<div class="grid grid-cols-2 gap-2 sm:gap-4">
  {
    strokeLinejoinValues.map(value => ( 
      <div>
        <h4>{value}</h4>
        <svg class="bg-base-300 w-full rounded sm:rounded-md" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
          <polyline points="50 10, 30 45, 70 45, 50 90" stroke="#F44336" fill="none" stroke-width="4" stroke-linejoin={value} />
        </svg>
      </div>
    ))
  }
...
```html /stroke-linejoin="miter"/ /stroke-linejoin="miter-clip"/ /stroke-linejoin="arcs"/ /stroke-linejoin="round"/ /stroke-linejoin="bevel"/
