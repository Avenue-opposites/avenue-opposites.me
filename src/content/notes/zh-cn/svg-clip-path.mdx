...
<svg class="svg-markdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  ...
  <CoordinateSystem 
    ...
    lines={[
      { x1: 50, y1: 10, x2: 30, y2: 45, color: 'red' },
      { x1: 30, y1: 45, x2: 70, y2: 45, color: 'red' },
      { x1: 70, y1: 45, x2: 50, y2: 90, color: 'red' },
      { x1: 50, y1: 90, x2: 50, y2: 10, color: 'red' },
    ]}
    mergeLines
    mergePoints
  >
...
```html ml [++{3-5, 9}] /clip-path="url(#my-clip)"/
