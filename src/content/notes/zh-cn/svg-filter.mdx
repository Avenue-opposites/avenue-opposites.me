...
lang: zh-CN
---
import FeColorMatrixDemo from '~/components/SVG/FeColorMatrixDemo.astro'
import FeBelndDemo from '~/components/SVG/FeBlendDemo.astro'
import FeComposite from '~/components/SVG/FeComposite.astro'
import FeComponentTransferDemo from '~/components/SVG/FeComponentTransferDemo.astro'
import FeMorphologyDemo from '~/components/SVG/FeMorphologyDemo.astro'
import FeDisplacementMapDemo from '~/components/SVG/FeDisplacementMapDemo.astro'
import FeTurbulenceDemo from '~/components/SVG/FeTurbulenceDemo.astro'
import FeConvolveMatrixDemo from '~/components/SVG/FeConvolveMatrixDemo.astro'
export const colorMatrix = ['R', 'G', 'B', 'A', '1']
export const newColorMatrix = ['R\'', 'G\'', '\B\'', 'A\'']
export const matrix = Array.from({ length: 4 }, () => Array.from({ length: 5 }, (_, j) => `r${j}`))
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
	<filter id="composite">
		<feImage href="/images/wallpaper.png" preserveAspectRatio="xMidYMid slice" result="image" /> <!-- [!code focus] -->
		<feComposite in="SourceGraphic" in2="image" operator="操作符" /> <!-- [!code focus] -->
	</filter>
	<image
		href="/images/figma.png"
		x="0" y="0" width="100" height="100"
